<template>
    <div>
        <div>
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex-no-shrink ml-auto">
                    ...
                    >Créer un nouveau layout</button>
                </div>
            </div>
        ...
        <div ref="creationForm">
            <div v-if="creation">
                <div class="flex justify-between items-center mb-6">
                    <heading class>Nouveau layout</heading>
                </div>
...
export default {
    ...
    methods: {
        ...
        saveLayout() {
            Nova.request()
                .post("/nova-vendor/newsletter/layouts", {
                    name: this.name,
        ...
        handleImageAdded(file, Editor, cursorLocation, resetUploader) {
            ...
            Nova.request()
                .post("/nova-vendor/newsletter/layouts/image", formData)
                .then(({ data }) => {
                    let url = data;
        ...
        handeImageRemoved(file, Editor, cursorLocation) {
            Nova.request()
                .put("/nova-vendor/newsletter/layouts/delete-image", {
                    path: file
                })
                .then(({ data }) => {});
        },
        abendCreation() {
            if (this.imagePaths.length > 0) {
                Nova.request()
                    .put("/nova-vendor/newsletter/layouts/delete-images", {
