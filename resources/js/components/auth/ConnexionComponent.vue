                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <div v-if="accountExist && firstVerificationDone">
                            ...
                            <div class="flex w-full justify-end text-xs mb-3 hover:underline">
                                <router-link
                        ...
                        <div v-if="!accountExist && firstVerificationDone">
                            ...
                            >
                                <input
                                    ...
                                    v-model="userCreation.birth_date"
                                />
                            </div>

                            <div id="divier" class="w-48 bg-secondary mx-auto h-px my-3"></div>
                            ...
                            >
                                ...
                                <span v-bind:class="{ hidden: passwordCreationVisible }">
                                    <i
                                        class="la la-eye-slash text-xl text-gray-600 hover:cursor-pointer hover:text-gray-900"
                                        @click="togglePasswordCreationVisible()"
                                    ></i>
                            ...
                            >
                                ...
                                />
                                <span v-bind:class="{ hidden: !passwordConfirmCreationVisible }">
                                    <i
                                        class="la la-eye text-xl text-gray-600 hover:cursor-pointer hover:text-gray-900"
                                        @click="togglePasswordConfirmCreationVisible()"
                                    />
                                </span>
                                <span v-bind:class="{ hidden: passwordConfirmCreationVisible }">
                                    <i
